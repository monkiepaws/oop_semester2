...
namespace BankingAccountLibrary.Tests
{
    ...
    public class CreditAccountTests
    {
        ...
        public void CreditAccount_ValidInput_CorrectOutput(string accountNumber, string customerName, string pin, decimal balance)
        {
            // Arrange
            StandardAccountDetails details = new StandardAccountDetails(accountNumber, customerName, pin, balance);
            CreditAccount tested = new CreditAccount(details);
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(tested.CreditLimit == -2000);
        ...
        [TestCase("456987123", "Larry Emerald", "147852", 100.88, 1900.44)]
        ...
        [TestCase("123456789", "Harry Who", "987654", 6000.89, 6000.89)]
        [TestCase("987654321", "Barry Bob", "123456", -22, -24.2)]
        [TestCase("456987123", "Larry Emerald", "147852", -1000, -1100)]
        ...
        public void IsValidPin_ValidInput_CorrectOutput(string pin)
        {
            ...
            CreditAccount test = new CreditAccount(details);
